...
def main():
    # We are loading the BASE model only, with NO LoRA adapter.
    ...
    # Load base model with 4-bit quantization just like during training and adapter inference
    ...
    # Define the exact same 6 test cases for a direct 1:1 comparison
    test_cases = [
        {
    ...
    # Replacing the specialized system prompt with a generic one
    system_message = "You are a helpful math tutor. Solve the problem step by step."

    print("\nStarting generation for BASE model...\n")
    for i, test in enumerate(test_cases, 1):
        ...
        print("GENERATED RESPONSE (BASE MODEL):")
