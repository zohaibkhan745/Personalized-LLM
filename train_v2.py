"""
train_v2.py — Fine-tune Meta-Llama-3-8B-Instruct with QLoRA on a single RTX 4090.

Changes vs train.py (conservative LoRA to prevent catastrophic forgetting):
  1. LoRA target_modules: attention-only ["q_proj","k_proj","v_proj","o_proj"]
  2. LoRA rank / alpha:   r=8, lora_alpha=16  (was r=16, lora_alpha=32)
  3. num_train_epochs:    2                   (was 3)
  4. output_dir:          ./llama3-math-tutor-adapter-v2
...
OUTPUT_DIR = "./llama3-math-tutor-adapter-v2"   # ← CHANGE 4: separate output dir
...
def get_training_args() -> SFTConfig:
    ...
    return SFTConfig(
        ...
        num_train_epochs=2,                         # ← CHANGE 3: was 3
